...
void showImage(File dir, int numTabs)
{
  while (true)
  {
    ...
    entry.close();
    bmpDraw(entry.name(), 0, 0);      //Calling the bmpDraw function ("Name_of_your_image.bmp",x,y) (x,y) is the starting position of the picture drawing
    delay(2000); 
  }
}